...
Direktes MS/TP, BACnet/SC, eine vollständige BBMD/Foreign-Device-Lösung und semantische Decoder für alle komplexen BACnet-Strukturen sind nicht Bestandteil von 0.3.1. MS/TP-Geräte können über einen vorhandenen BACnet-Router erscheinen.
