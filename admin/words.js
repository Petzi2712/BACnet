...
window.systemDictionary = {
	...
	pollingAndWriting: { en: "Polling & writing", de: "Polling & Schreiben" },
	...
	deviceSelectionHelp: {
		...
		de: "Discovery starten, das Geräteinventar einlesen und anschließend nur die Punkte auswählen, die im ioBroker-Objektbaum erscheinen sollen. Beim Speichern werden abgewählte Punkte und leere Pfade entfernt."
	},
	active: { en: "Active", de: "Aktiv" },
	inactive: { en: "Inactive", de: "Inaktiv" },
	startDiscovery: { en: "Start discovery", de: "Discovery starten" },
	cancelDiscovery: { en: "Cancel discovery", de: "Discovery abbrechen" },
	...
	searchPlaceholder: {
		...
		de: "Gerät, Beschreibung, Hersteller, Objekt, Property oder stabile ID suchen…"
	},
	...
	noDevices: {
		...
		de: "Noch keine Geräte bekannt. Discovery starten, während die Adapterinstanz läuft."
	},
	...
	discoveryTimeoutMs: { en: "Discovery window (ms)", de: "Discovery-Zeitfenster (ms)" },
	...
	autoImportAll: { en: "Automatically read all conflict-free devices after discovery", de: "Nach Discovery alle konfliktfreien Geräte automatisch einlesen" },
	staleScansBeforeDelete: { en: "Successful scans before stale cleanup", de: "Erfolgreiche Scans vor Stale-Bereinigung" },
	...
	pollingEnabled: { en: "Enable polling", de: "Polling aktivieren" },
	covEnabled: { en: "Use COV where supported", de: "COV verwenden, wenn unterstützt" },
	pollIntervalMs: { en: "Polling interval (ms)", de: "Pollingintervall (ms)" },
	requestConcurrency: { en: "Global request concurrency", de: "Globale Request-Parallelität" },
	perDeviceConcurrency: { en: "Per-device request concurrency", de: "Request-Parallelität je Gerät" },
	...
	discoveryStarted: { en: "Discovery started…", de: "Discovery gestartet…" },
	discoveryCompleted: { en: "Discovery completed.", de: "Discovery abgeschlossen." },
	discoveryCancelled: { en: "Discovery cancelled.", de: "Discovery abgebrochen." },
